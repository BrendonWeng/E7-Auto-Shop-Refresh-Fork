...
while keyboard.is_pressed('q') == False:
    RB_pos=None
    while RB_pos is None:
        RB_pos=pyautogui.locateOnScreen('refresh_button.png',confidence=0.7)
        time.sleep(1.0)
        print('still searching for refresh')
#The confidence is added due to little variations in the background
    Coven_pos=pyautogui.locateOnScreen('covenant.png',confidence=0.7)
    Mystic_pos=pyautogui.locateOnScreen('mystic.png',confidence=0.7)
    time.sleep(1.0)
#Checks for covenant
    if (Coven_pos) != None:
        time.sleep(1.0)
        ...
        click(Coven_point[0]+800, Coven_point[1]+50)
        time.sleep(1.0)#wait for confirm button
        Buy_button_Covenant_pos=pyautogui.locateOnScreen('Buy_button_Covenant.png',confidence=0.5)
...
#checks for mystic
    if (Mystic_pos) != None:
        ...
        click(Mystic_point[0]+800, Mystic_point[1]+50)
        time.sleep(1.0)#wait for confirm button
        Buy_button_Mystic_pos=pyautogui.locateOnScreen('Buy_button_Mystic.png',confidence=0.5)
    ...
    time.sleep(3)
    click(x=1263,y=590)
    Coven_pos2=pyautogui.locateOnScreen('covenant.png',confidence=0.7)
    Mystic_pos2=pyautogui.locateOnScreen('mystic.png',confidence=0.7)
...
#Checks for covenant
    if (Coven_pos2) != None:
        ...
        click(Coven_point[0]+800, Coven_point[1]+50)
        time.sleep(1.0)#wait for confirm button
        Buy_button_Covenant_pos=pyautogui.locateOnScreen('Buy_button_Covenant.png',confidence=0.7)
        Buy_button_Covenant_point=pyautogui.center(Buy_button_Covenant_pos)
        click(Buy_button_Covenant_point[0], Buy_button_Covenant_point[1])
        click(Buy_button_Covenant_point[0], Buy_button_Covenant_point[1])
        time.sleep(1.0)
...
#checks for mystic
    if (Mystic_pos2) != None:
        ...
        click(Mystic_point[0]+800, Mystic_point[1]+50)
        time.sleep(1.0)#wait for confirm button
        Buy_button_Mystic_pos=pyautogui.locateOnScreen('Buy_button_Mystic.png',confidence=0.7)
        Buy_button_Mystic_point=pyautogui.center(Buy_button_Mystic_pos)
        click(Buy_button_Mystic_point[0], Buy_button_Mystic_point[1])
        click(Buy_button_Mystic_point[0], Buy_button_Mystic_point[1])
        time.sleep(1.0)
...
#Finally refreshes
    ...
    click(RB_point[0], RB_point[1])
    time.sleep(1.0)#wait for confirm to appear
    Confirm_pos=pyautogui.locateOnScreen('confirm button.png',confidence=0.7)
